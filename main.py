...
players = []
players.append(Rect(150, 150, random.randint(60, 150)*1.5, random.randint(60, 150)*1.5, random.randint(0, 5), random.randint(0, 5), (245, 66, 126), (112, 17, 49)))
...
while True:
    ...
    if players[0].s > 0.4 and players[1].s > 0.4:
    ...
    for i in range(max(n1, n2)):
        ...
        if players[0].rect.colliderect(players[1].rect) and players[0].s > 0.4 and players[1].s > 0.4:
